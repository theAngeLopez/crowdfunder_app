class ProjectsController < ApplicationController
 ...
 private
 def project_params
   params.require(:project).permit(:name, :description, :funding_goal, :start_date, :end_date, :category, rewards_attributes: [:description, :_destroy, :name, :backer_limit, :amount])
 end
end
